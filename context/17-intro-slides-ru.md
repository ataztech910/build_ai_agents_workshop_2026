...
Формат: ~2ч45 с перерывом в середине, офлайн, для технарей. Идём от самого простого агента до
...
на агентов не в игрушечных условиях, а встроенными в реальный процесс (n8n) —
это уже не 5-минутная приписка, а полноценный закрывающий пайплайн
(planner → data portal → lead-finder → n8n группирует результат).
...
| Закрытие | planner → data portal → lead-finder → n8n группирует, плюс быстрый круг | 25 мин |

*(10+25+30+25+30+20+25 = 165 мин ≈ 2ч45 — перерыв добавлен сверху, а не
за счёт урезания блоков; Закрытие выросло с 5 до 25 мин, когда решили
показать полный 3-звенный пайплайн через n8n, а не одну ноду — см.
`tasks/03-closing.md`)*
